                    ...
                    Group {
                        VStack(spacing: 0) {
                            ...
                            HStack {
                                Text("File path")
                                Spacer()
                                Directory(path: $sampleStore.newSample.sourceFilePath, openInFinder: false, mode: .file)
                            }.padding(.vertical)
                            Divider()
                            HStack {
                                Text("Series path")
                                Spacer()
                                Directory(path: $sampleStore.newSample.targetPlaylistPath, openInFinder: false, mode: .directory)
                            }.padding(.vertical)
                        }.padding(.horizontal)
                            .overlay(
